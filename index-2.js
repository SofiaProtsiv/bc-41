...
//     this.kbk = 8;
//     this.jbsjd = 87;
//     console.log(this.kbk);
//   },
// };

// // anotherUser.kbk = "reading";
...
// console.log(someFunction(user.showThis));
...
// };
// // // console.log(window);
// // // window.document.title = "BC 41 super!";
// user.go(35);
// console.log(user);
